...
(function () {
    ...
    Array.prototype.forEach.call(frames, function (f) {
        var m = (f.getAttribute('src') || '').match(/\/embed\/([A-Za-z0-9_-]{6,})/);
    ...
    // клоны не вызывают наши обработчики — считаем только оригиналы
    function onLoad() {
        loaded++;
    ...
    setTimeout(function () { if (!loaded) removeLayer(); }, 9000);
})();